...
//   var reserve_time = $('.reserve_time:nth-child('+index+')').val();
//
...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
            ...
            swal(
                {
                    ...
                    confirmButtonText: '최종 과제 제출 및 종료하기'
                }
            )
        });
        ...
        $('button.swal2-modal.swal2-styled').click(function () {
            swal(
                {
                    text: '현재 상태에서 과제를 저장하시겠습니까?',
                    type: 'info',
